...
- **Память о человеке.** Загрузи скилл `person-memory`, когда просят показать, что известно о
  конкретном человеке, или явно добавить/исправить факт в существующей карточке контакта.
