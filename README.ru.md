...
- **Память о людях** - `/person <человек>` показывает актуальные знания со ссылками на источники; owner-only меню безопасно добавляет или явно исправляет один факт без дублей контактов и потери History.
