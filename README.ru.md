...
<img src="assets/iva-userbot.webp" alt="Секретарь в Telegram: userbot читает групповые чаты с вашего аккаунта и собирает сводки через серверный read-only registry" width="100%">
