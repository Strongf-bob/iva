...
- **Граф контактов Telegram (только чтение)** - полная доступная текстовая история постепенно
  превращается в карточки людей, групп, проектов и владельца с доказательствами. Одновременно идут
  три чата, а numeric Telegram ID связывает одного человека между личкой и группами.
...
- **Ограниченный граф контактов** - каждый sync делает не больше одного запроса к модели на чат и
  ...
  следующим инкрементальным проходам; содержимое голосовых и видеокружков здесь не анализируется.
