...
- **Граф, который продолжает с места остановки** - первый read-only импорт проходит всю текстовую
  историю, затем расписание раз в 15 минут продолжает с сохранённых курсоров. У каждого наблюдения
  остаётся ссылка на исходное сообщение; содержимое голосовых и видеокружков здесь не анализируется.
