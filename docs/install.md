...
- ⚙️ **Background runtime** — two systemd user services, two systemd watchdog timers and six in-process eve schedules, with linger enabled so they survive logout. Details: [deploy.md](deploy.md).
