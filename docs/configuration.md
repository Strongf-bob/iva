...
| `ASSISTANT_TIMEZONE`       | `Europe/Moscow`                | IANA name. Sets reminder wall-clock calculations, daily-transcript dates, host watchdog timers, in-process eve schedules, and the date/time Iva sees each turn. Exported as `TZ`.                                                                                                                              |
| `ASSISTANT_VAULT_DIR`      | `memory`                       | The live memory: a separate private git repo, opens in Obsidian.                                                                                                                                                                                                                                               |
| `ASSISTANT_DATA_DIR`       | `data`                         | Runtime data: tasks, usage, durable reminders, and scheduler status. Personalized workers receive their own bounded directory.                                                                                                                                                                                 |
